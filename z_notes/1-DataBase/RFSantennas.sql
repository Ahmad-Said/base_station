...
CREATE TABLE IF NOT EXISTS `antennas` (
  `antennaId` int(11) NOT NULL AUTO_INCREMENT,
  `xxx` text,
  `Total #RF ports` int(11) DEFAULT NULL,
  `Gain (dBi) (<1GHz)` text,
  ...
  `#ports (<1GHz)` int(11) DEFAULT NULL,
  `#ports (1-3GHz)` int(11) DEFAULT NULL,
  `#ports (>3GHz )` int(11) DEFAULT NULL,
...
DROP TABLE IF EXISTS `antennatypes`;
CREATE TABLE IF NOT EXISTS `antennatypes` (
  `antennaTypeId` int(11) NOT NULL AUTO_INCREMENT,
  `antennaTypeName` text NOT NULL,
  `antennaFamilyId` int(11) NOT NULL,
  PRIMARY KEY (`antennaTypeId`)
